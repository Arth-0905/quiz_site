        ...
        <div class="bg-white w-full rounded-2xl">
            <div class="p-4 text-center">
                ...
                <div class="question-wrap">
                    <form action="{{route('wrong_answer')}}" method="get">
                        @csrf
            ...
            <div class="flex">
                ...
                <p class="flex-1 p-2">
                    <a href="{{route('wrong_show', $previousQuestionId)}}" class="link hover:text-blue-500">
                        前の問題へ
                    </a>
                </p>
                @endif
                ...
                <p class="flex-2 text-right p-2">
                    <a href="{{route('wrong_show', $nextQuestionId)}}" class="link hover:text-blue-500">
                        次の問題へ
                    </a> 
                </p>
                @endif
